...
set CLASSPATH=%APP_HOME%\lib\app.jar;%APP_HOME%\lib\guava-32.1.3-jre.jar;%APP_HOME%\lib\vertx-web-4.5.7.jar;%APP_HOME%\lib\vertx-web-client-4.5.7.jar;%APP_HOME%\lib\vertx-web-common-4.5.7.jar;%APP_HOME%\lib\vertx-auth-common-4.5.7.jar;%APP_HOME%\lib\vertx-bridge-common-4.5.7.jar;%APP_HOME%\lib\vertx-uri-template-4.5.7.jar;%APP_HOME%\lib\vertx-core-4.5.7.jar;%APP_HOME%\lib\rxjava-3.1.8.jar;%APP_HOME%\lib\failureaccess-1.0.1.jar;%APP_HOME%\lib\listenablefuture-9999.0-empty-to-avoid-conflict-with-guava.jar;%APP_HOME%\lib\jsr305-3.0.2.jar;%APP_HOME%\lib\checker-qual-3.37.0.jar;%APP_HOME%\lib\error_prone_annotations-2.21.1.jar;%APP_HOME%\lib\netty-handler-proxy-4.1.108.Final.jar;%APP_HOME%\lib\netty-codec-http2-4.1.108.Final.jar;%APP_HOME%\lib\netty-codec-http-4.1.108.Final.jar;%APP_HOME%\lib\netty-resolver-dns-4.1.108.Final.jar;%APP_HOME%\lib\netty-handler-4.1.108.Final.jar;%APP_HOME%\lib\netty-transport-native-unix-common-4.1.108.Final.jar;%APP_HOME%\lib\netty-codec-socks-4.1.108.Final.jar;%APP_HOME%\lib\netty-codec-dns-4.1.108.Final.jar;%APP_HOME%\lib\netty-codec-4.1.108.Final.jar;%APP_HOME%\lib\netty-transport-4.1.108.Final.jar;%APP_HOME%\lib\netty-buffer-4.1.108.Final.jar;%APP_HOME%\lib\netty-resolver-4.1.108.Final.jar;%APP_HOME%\lib\netty-common-4.1.108.Final.jar;%APP_HOME%\lib\jackson-core-2.16.1.jar;%APP_HOME%\lib\reactive-streams-1.0.4.jar
